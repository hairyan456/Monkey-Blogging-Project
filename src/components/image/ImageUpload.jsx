...
const ImageUpload = (props) => {
    const { name, className = "", progress = 0, image = "", imageName = '', handleDeleteImage = () => { }, ...rest } = props;
    return (
        <label
            className={`cursor-pointer bg-gray-100 flex items-center justify-center border border-dashed w-full min-h-[200px] rounded-lg ${className} relative overflow-hidden group`}
        >
            <input
                type="file"
                name={name}
